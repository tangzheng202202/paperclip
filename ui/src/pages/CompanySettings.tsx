    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          ...
          <Field
            ...
            hint={t("settings.optionalDescriptionHint")}
          >
            <input
              className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
              type="text"
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-3">
          <ToggleField
            label={t("settings.requireApprovalForNewHires")}
            hint={t("settings.requireApprovalForNewHiresHint")}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-center gap-1.5">
            ...
            <HintIcon text={t("settings.generateOpenClawInviteHint")} />
          </div>
            ...
            <Button
              ...
              onClick={() => {
                ...
                const confirmed = window.confirm(
                  t("settings.archiveConfirm").replace("{name}", selectedCompany.name)
                );
                if (!confirmed) return;
                const nextCompanyId =
                  companies.find(
