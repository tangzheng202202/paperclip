            ...
            <div className="border-t border-r border-border px-3 py-2 bg-background">
              <div className="flex items-center gap-1">
                ...
                <Button
                  ...
                  onClick={toggleTheme}
                  aria-label={nextTheme === "light" ? t("layout.switchToLightMode") : t("layout.switchToDarkMode")}
                  title={nextTheme === "light" ? t("layout.switchToLightMode") : t("layout.switchToDarkMode")}
                >
